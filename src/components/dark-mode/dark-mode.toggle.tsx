...
const DarkModeToggle = (props: Props) => {
  ...
  const [theme, setTheme] = useState(localTheme ? localTheme : 'emerald')

  const handleToggle = (e: any) => {
    if (e.target.checked) {
      setTheme('emerald-dark')
    } else {
      setTheme('emerald')
    }
  }
  ...
  return (
    <label className='swap swap-rotate'>
      ...
      <input className='hidden' type='checkbox' checked={theme === 'emerald' ? false : true} onChange={handleToggle} />
      {/* sun icon */}
