...
const HomeForSalePage = () => {
  ...
  const homeForSaleListings = [
    ...
    },
    {
      id: 4,
      images: [
        "https://images.unsplash.com/photo-1574259392081-dbe3c19cd15e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTB8fGhvdXNlfGVufDB8fDB8fHww",
      ],
      type: "4 Bedroom",
        ...
        ({
          ...
          <div key={id} className=" flex flex-col w-1/2 md:w-1/3 lg:w-1/4 p-2">
            ...
            <div key={id} className=" w-auto px-[0.625rem] pt-3 lg:pt-6 lg:px-[1.125rem]">
              <h4 className=" font-openSans text-[0.625rem] pb-3 font-semibold text-[#1E1E1E] opacity-80 lg:pb-6 lg:text-base">
                {type}
              </h4>
              <h4 className=" font-openSans text-[0.5625rem] pb-[0.4375rem] font-bold text-[#1E1E1E] opacity-90 lg:pb-3 lg:text-base">
                {address}
              </h4>
              ...
              <section className=" flex items-center justify-between">
                <h5 className=" font-openSans text-[0.625rem] font-semibold text-[#1E1E1E] opacity-70 lg:text-sm">
                  {location}
                </h5>
                <svg
