...
const MyListingsPage = async ({ searchParams }: { searchParams?: { page?: string; query?: string } }) => {
  const pageNumber = searchParams?.page && typeof searchParams.page === 'string' ? +searchParams.page : 1;
